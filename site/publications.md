{
"title" : "Your scientific publication",
"layout": "defaultESUG",
...
ESUG offers 150 Euros for international conference papers whose concepts involve an implementation in Smalltalk.
Note that this program does not apply on conferences already sponsored or organized by us (IWST for example).

### Rules
- The applicant should be an ESUG member or a Pharo association member.
...
- In case the ESUG board decides to support the promotion, the author has to send to ESUG after the camera-ready deadline a PDF of the article, where ESUG is referenced in the acknowledgment section, including a link to https://www.esug.org
...
- David Röthlisberger, Oscar Nierstrasz and Stéphane Ducasse, "Autumn Leaves: Curing the Window Plague in IDEs", WCRE 2009
